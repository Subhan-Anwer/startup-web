  ...
  return (
    <footer className='w-full h-[125px] bg-[#74c69d] flex justify-center items-center'>
        <div className='w-[81%] max-w-[1180px] lg:h-[25px] h-[55px]  flex lg:flex-row flex-col justify-between items-center mx-8'>
            <div className='w-[242px] h-[18px] flex justify-center items-center sm:gap-[20px] gap-[15px]'>
            ...
            <h6 className='sm:w-[295px] w-[245px] h-[25px] text-white leading-[125%] sm:text-[20px] text-[16px] text-right'>© Start, 2022. All rights reserved.</h6>
        </div>
    </footer>
  )
}
